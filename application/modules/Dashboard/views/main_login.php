...
<head>
    ...
    <!-- <script src="https://www.google.com/recaptcha/enterprise.js?render=6LcNVoEpAAAAAKkyfW7U2fFT9rKsiRl7xNA4neU5"></script> -->
...
<body>
    ...
    <div id="">
        <div class="">
            <div class="container">
                <div class="row justify-content-center align-items-cente tab-row">
                    <div class="col-lg-8">
	...
	c-1.249,0-3.544,0.181-4.472,0.219c-0.928,0.038-1.366,0.012-1.521-0.051C-0.073,14.571,0.031,14.306,0.095,14.197z">
                                    ...
                                    <!-- <p>Sign In Using Your User Name And Password</p> -->
                                </div>

                                <div class="col-sm-12 col-md-12 text-white text-center mt-4">
                                    <h5
                                        style="text-transform: uppercase;color: #000;font-weight: bold;font-size: 22px;">
                                    </h5>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="password-field eyebx position-relative mb-3">
                                                <input type="password" id="fakePassword" class="form-control "
                                                    placeholder="Enter Password" name="password"
                                                    value="<?php echo set_value('password'); ?>">
                                                <span
                                                    class="ion ion-locked form-control-feedback eye-btn ion ion-locked form-control-feedback eye-btn toggle"><i
                                                        id="toggler" class="far fa-eye"></i></span>
                                            </div>
                                            <!-- SITE KEY ::--- 6Ld8xoEpAAAAAJU1-an3C3ssJPGYBbE_emd_1rRv -->
                                            <!-- <div class="g-recaptcha" data-sitekey="6Ld8xoEpAAAAAJU1-an3C3ssJPGYBbE_emd_1rRv"></div> -->

                                            <div class="details password-form mt-3">
                                                <div
                                                    class="d-flex align-item-center justify-content-between position-relative">
                                                    <div class="form-check-inline m-0">
                                                        <input id="deviceremember" type="checkbox" class="mr-2 ">
                                                        <label class="form-check-label add-color"
                                                            for="deviceremember">Remember Me</label>
                                                    </div>
                                                    <a href="<?php echo base_url('dashboard/forget-password') ?>"
                                                        class="forgot_pw add-color">Forgot Password?</a>
                                                </div>
                                                <div class="form-group has-feedback">
                                                    <button type="button" id="deposit"
                                                        onclick="submit_form(this, 'mainLogin')" value="login"
                                                        class="button-three">Log in</button>
                                                </div>
                                                <div class="text-center create-acc mt-3">

                                                    <p class="m-0">Still No Account? <a
                                                            href="<?php echo base_url(); ?>register"
                                                            class="tgreen">Create New Acount</a></p>
